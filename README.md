...
For params validation - rule of thumb - we should be strict with our output that we produce, and permissive with 
...
AI usage - I was using Kimi K2.7-coder, works pretty good once it have good examples, does not know about Spring Boot 4
